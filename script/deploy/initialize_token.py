...
PRIVATE_KEY = "SAHWNEINQPCHBVPFSD5Q4B3MEHB272XDA54AK54UMNIIUXXAHQWF47ZV"
CONTRACT_ID = input("👉 Enter contract id: ")
sender_keypair = Keypair.from_secret(PRIVATE_KEY)
soroban_server = SorobanServer(server_url="https://testnet.sorobanrpc.com")
...
test_balance_admin(sender_keypair.public_key, 43224)
test_name("PICA Token")
test_symbol("PICA")
test_decimals(18)
